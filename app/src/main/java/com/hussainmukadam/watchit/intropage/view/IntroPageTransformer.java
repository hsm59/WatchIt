...
/**
 * Created by hussain on 21/10/17.
 */
...
public class IntroPageTransformer implements ViewPager.PageTransformer {
    ...
    public void transformPage(View page, float position) {
        ...
        if (position <= -1.0f || position >= 1.0f) {
            ...
            View rvMovies = page.findViewById(R.id.rv_genre_movies);
            View rvTv = page.findViewById(R.id.rv_genre_tv);
            ...
            // isn't null.
            if (pagePosition == 0 && rvMovies != null) {
                rvMovies.setAlpha(1.0f - absPosition);
                rvMovies.setTranslationX(pageWidthTimesPosition * 1.5f);
            }

            if(pagePosition == 1 && rvTv != null) {
                rvTv.setAlpha(1.0f - absPosition);
                rvTv.setTranslationX(pageWidthTimesPosition * 1.5f);
            }
